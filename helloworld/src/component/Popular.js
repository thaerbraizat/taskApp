    ...
    return (
      <>
                        ...
                        <div >
                            ...
                            <h1 style={{paddingTop:"140px" ,fontFamily:"monospace"}}> Popular movies </h1>
                            <Row xs={1} md={2} className="g-4"   >
    
                                {loginContext.popular.results &&
                                   loginContext.popular.results.map((movie, idx) =>
                                    (<>
                                        <Card>
                                        <Col>
